...
import com.js.subject.infrastructure.basic.mapper.SubjectJudgeDao;
...
public class SubjectJudgeServiceImpl implements SubjectJudgeService {
     ...
     */
    @Override
    public void batchInset(List<SubjectJudge> subjectJudgeLinkedList) {
        this.subjectJudgeDao.insertBatch(subjectJudgeLinkedList);
    }
}
